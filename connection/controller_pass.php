...
public function getModal($id){
  ...
  return '     
    ...
    <div>
      Web: '.strtoupper($fila[1]).'<p/>
      Centro: '.strtoupper($fila[2]).'<p/>
      Usuario: '.$fila[3].'<p/>
      Contraseña: '.$fila[4].'<p/>
    </div>
    <div data-label="EDITAR" id="'.$fila[0].'" alt="Pedit" class="tabla-celdas-prov">
      <img src="./img/outline_edit_black_48dp.png" class="btn-edit" alt="'.str_replace(' ','',$fila[0]).'" id="Pedit">
    </div>
    ...
    public function search($nombre){
      ...
      while($fila = $select->fetch()){
          ...
          <div class="tabla-filas-con">
            ...
            <div data-label="PAGINA" class="tabla-celdas-prov">'.strtoupper($fila[1]).'</div>
            <div data-label="CENTRO" class="tabla-celdas-prov">'.strtoupper($fila[2]).'</div>
            ...
            <div data-label="CONTRASEÑA" class="tabla-celdas-prov">'.$fila[4].'<input type="text" id="2'.$fila[0].'" value="'.$fila[4].'" class="hidden">
              <img src="./img/content_copy_black_24dp.svg" class="finger" onclick="copiar(2'.$fila[0].')" >
            </div>
