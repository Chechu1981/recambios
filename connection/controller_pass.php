    ...
    public function search($nombre){
      ...
      while($fila = $select->fetch()){
          ...
          <div class="tabla-filas-prov">
            ...
            <div data-label="EDITAR" class="tabla-celdas-prov">
              <a href="javascript:openWindow(\'./pass/modificar.php?id='.$fila[0].'\')" >
            ...
            <div data-label="INFO" id="Pinfo" class="tabla-celdas-prov">
